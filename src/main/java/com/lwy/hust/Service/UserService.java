...
import com.lwy.hust.DAO.UserDAO;
import com.lwy.hust.DAO.LoginTicketDAO;
...
public class UserService {
    ...
    public Map<String, Object> register(String username, String password)
    {
          ...
          user.setPassword(hustNewsUtil.MD5(password+user.getSalt()));
    ...
    public Map<String, Object> login(String username, String password) {
        ...
        if (!hustNewsUtil.MD5(password+user.getSalt()).equals(user.getPassword())) {
